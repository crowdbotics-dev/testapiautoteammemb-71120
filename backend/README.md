...
## Project Structure
    ...
    ├── testapiautoteammemb_71120  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_71120`
...
2. Clone this repo and `cd testapiautoteammemb_71120`
